    ...
    let i = {
      ...
      updateGBBlockPageIndicatorColor: function (r) {
        var r = r.find(".wpforms-page-indicator"),
          ...
          e = o.find(".wpforms-page-indicator-page-triangle");
        r.data("indicator-color", "var( --wpforms-button-background-color )"),
          o.css("background-color", "var( --wpforms-button-background-color )"),
          e.css("border-top-color", "var( --wpforms-button-background-color )");
      },
      updateGBBlockPageIndicatorColorF: function (r) {
        var o,
          e,
          r = r.querySelector(".wpforms-page-indicator");
        r &&
          ((e = (o = r.querySelector(
            ".wpforms-page-indicator-page-progress, .wpforms-page-indicator-page.active .wpforms-page-indicator-page-number"
          )).querySelector(".wpforms-page-indicator-page-triangle")),
          (r.dataset.indicatorColor =
      ...
      formSubmitButtonDisable: function (r, o, e) {
        ...
        e.before(
          `<div class="wpforms-hidden" id="${o}">${wpforms_settings.submitBtnDisabled}</div>`
        ),
          e
            .prop("disabled", !1)
      ...
      pageChange: function (r, e, t) {
        var a = t.find(".wpforms-page-indicator");
        if (wpforms_settings.indicatorStepsPattern && a.length) {
          ...
          (r = r.replace("{current}", e).replace("{total}", t)),
            (o = a.hasClass("progress")
              ...
              : a
                  .find(
                    `.wpforms-page-indicator-page-${e} .wpforms-page-indicator-page-title`
                  )
                  .text()),
            (r = o ? o + ". " + r : r),
      ...
      screenReaderAnnounce: function (r, o) {
        ...
        e.setAttribute("id", t),
          ...
          e.classList.add("wpforms-screen-reader-announce");
      ...
      getColorAsRGBArray: function (r) {
        ...
        return (
          r.match(/[0-9a-f]{6,8}$/gi)
            ? ((o = r.match(/\w\w/g).map((r) => parseInt(r, 16)))[3] = o[3]
                ? (o[3] / 255).toFixed(2)
                : 1)
      ...
      getCssVars: function (r) {
        ...
        for (
          var r = r.hasClass("wpforms-container")
            ...
            e = wpforms_settings.css_vars,
            t = {},
            a = 0;
          a < e.length;
          a++
        )
          t[e[a]] = i.getCssVar(o, "--wpforms-" + e[a]);
        return t;
      },
    };
    return i;
