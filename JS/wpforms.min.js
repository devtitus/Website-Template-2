    ...
    var p = {
      ...
      loadValidation: function () {
        void 0 !== l.fn.validate &&
          ...
          l(i).on("change", ".wpforms-validate input[type=url]", function () {
            var e = l(this).val();
            if (!e) return !1;
            "http://" !== e.substr(0, 7) &&
              "https://" !== e.substr(0, 8) &&
          ...
          l.validator.addMethod("step", function (e, t, r) {
            n = r;
            const a =
              (Math.floor(n) !== n && n.toString().split(".")[1].length) || 0;
            function o(e) {
                          ...
                          return (
                            ...
                            a
                              ...
                              ? (l(".wpforms-input-temp-name").removeAttr(
                                ...
                                void p.formSubmit(e))
                              : (grecaptcha.execute(n).then(null, function () {
          ...
          l.post({
            ...
            success(e) {
              ...
              e ||
                ...
                o.showErrors(t)),
                (p.cache[n].restrictedEmailValidation =
                  p.cache[n].restrictedEmailValidation || []),
                Object.prototype.hasOwnProperty.call(
                  p.cache[n].restrictedEmailValidation,
                  a
                ) || (p.cache[n].restrictedEmailValidation[a] = e),
                o.stopRequest(r, e);
            },
          });
      },
          ...
          l(".wpforms-datepicker-wrap").each(function () {
            ...
            o &&
              ...
              (r.disable = [
                function (e) {
                  for (var t in o)
                    if (n.indexOf(o[t]) === e.getDay()) return !1;
                  return !0;
                },
              ])),
      ...
      loadMailcheck: function () {
        wpforms_settings.mailcheck_enabled &&
          ...
          l(i).on("blur", ".wpforms-field-email input", function () {
            var e = l(this),
              o = e.attr("id");
            e.mailcheck({
      ...
      bindUIActions: function () {
        ...
        e.on("click", ".wpforms-page-button", function (e) {
          ...
          l(i).on("change", ".wpforms-field-rating-item input", function () {
            var e = l(this),
              t = e
          ...
          e.on("input", ".wpforms-field-file-upload", function () {
            var e = l(this),
              ...
              n = e.find("button.wpforms-submit"),
              i = e.prev(),
              s = n.closest("form"),
            ...
            0 !== s.find(".wpforms-page-indicator").length &&
              ...
              a < r
                ? (i.find(".wpforms-error-container-post_max_size").remove(),
                  n.prop("disabled", !1),
                  WPFormsUtils.triggerEvent(
                    s,
                ...
                : ((a = Number((a / 1048576).toFixed(3))),
                  ...
                  i.hasClass("wpforms-error-container")
                    ? (i
          ...
          i = (
            t
              ? ((i = e),
                (o = t),
                (n = Math.pow(10, o)),
                "" + (Math.round(i * n) / n).toFixed(o))
              : "" + Math.round(e)
          ).split(".");
        return (
          3 < i[0].length &&
            (i[0] = i[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, a)),
          (i[1] || "").length < t &&
            ((i[1] = i[1] || ""),
      ...
      createCookie: function (e, t, r) {
        var a,
          o = "",
          n = "";
        wpforms_settings.is_ssl && (n = ";secure"),
          (o = r
            ? "-1" === r
              ? ""
        ...
        l.each(e, function (e, t) {
          switch (e) {
            case "header":
              ...
              break;
            case "footer":
              0 === a.find(".wpforms-page-indicator").length
                ? a.find(".wpforms-submit-container").before(t)
                : a.find(".wpforms-page-1").append(t);
              break;
            case "recaptcha":
          ...
          p.isModernMarkupEnabled() &&
            ...
            a.attr("aria-errormessage", r + ` wpforms-${o}-${e}-error`));
        });
      },
      ...
      setCurrentPage: function (a, o) {
        if (0 !== a.find(".wpforms-page-indicator").length) {
          ...
          var n = 0 < r.length ? r[0] : a.find(".wpforms-page-1");
          let e,
            t = "prev";
          1 === n.data("page") ||
          (void 0 !== o.errors && void 0 !== o.errors.general.footer)
            ? (e = a.find(".wpforms-page-1").next())
            : ((e = 0 !== n.next().length ? n.next() : n.prev()),
              (t = 0 !== n.next().length ? "prev" : "next"));
          (o = e.find(".wpforms-page-next")), (n = e.data("page"));
          p.navigateToPage(o, t, n, a, l(".wpforms-page-" + n));
        }
      },
